    ...
    return (
      <li key={nanoid()}>
        <button
          id={id}
          className={clsx(
            "customTransition flex items-center justify-center py-[6px] px-[10px] border-[0.8px] border-purple-200 rounded-lg mr-[12.75px] text-purple-100 text-[15px] font-medium leading-[1.25rem] text-center shadow-answer active:translate-y-[2.5px] active:shadow-none",
            {
